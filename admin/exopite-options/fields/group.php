 ...
 *   fields are not
 */
if ( ! class_exists( 'Exopite_Options_Framework_Field_group' ) ) {
	class Exopite_Options_Framework_Field_group extends Exopite_Options_Framework_Fields {
		...
		public function output() {
			...
			$self                      = new Exopite_Options_Framework( $base_id, null );
