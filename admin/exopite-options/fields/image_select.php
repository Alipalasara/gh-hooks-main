 ...
 *
 */
if ( ! class_exists( 'Exopite_Options_Framework_Field_image_select' ) ) {

	class Exopite_Options_Framework_Field_image_select extends Exopite_Options_Framework_Fields {
