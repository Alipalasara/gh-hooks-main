 ...
 */
if ( ! class_exists( 'Exopite_Options_Framework_Field_upload' ) ) {

	class Exopite_Options_Framework_Field_upload extends Exopite_Options_Framework_Fields {
		...
		public function output() {
			...
			$maxsize = Exopite_Options_Framework_Upload::file_upload_max_size();
			if ( isset( $this->field['options']['maxsize'] ) && Exopite_Options_Framework_Upload::file_upload_max_size() >= $this->field['options']['maxsize'] ) {
				$maxsize = $this->field['options']['maxsize'];
			}

			$allowed_mime_types = ( gettype( Exopite_Options_Framework_Upload::allowed_mime_types() ) == 'array' ) ? implode( ',', Exopite_Options_Framework_Upload::allowed_mime_types() ) : Exopite_Options_Framework_Upload::allowed_mime_types();
            ...
            <div class="qq-template-info">
				...
				echo esc_attr__( 'Max file upload size: ', 'exopite-sof' ) . number_format( (float) ( Exopite_Options_Framework_Upload::file_upload_max_size() / 1048576 ), 2, '.', '' ) . 'Mb<br><br>';
