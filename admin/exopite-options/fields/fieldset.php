 ...
 *
 */
if ( ! class_exists( 'Exopite_Options_Framework_Field_fieldset' ) ) {

	class Exopite_Options_Framework_Field_fieldset extends Exopite_Options_Framework_Fields {
		...
		public function output() {
			...
			$self  = new Exopite_Options_Framework( array(
