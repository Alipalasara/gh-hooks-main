...
public function create_menu() {
        ...
        $config_submenu = array(
            ...
            'title'             => 'Test Admin Page',               // The title of the options page and the name in admin menu
       ...
       $fields[] = array(
         ...
         */
        $options_panel = new Exopite_Options_Framework( $config_submenu, $fields );
        $options_panel = new Exopite_Options_Framework( $config_metabox, $fields );
